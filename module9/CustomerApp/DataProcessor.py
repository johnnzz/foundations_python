...
# Date:  12/12/2020
# ChangeLog:
#   8/19/2016, John Navitsky, Added EnsureExists method to File class
# ----------------------------------------#
...
class File(object):
    ...
    # Date:  12/12/2015
    # ChangeLog:
    #   8/19/2016, John Navitsky, Added EnsureExists method
    # -------------------------------------#
    ...
    def EnsureExists(self):
        """Appends nothing to file to ensure it exists"""
        try:
            objFile = open(self.FileName, "a")
            objFile.close()
        except Exception as e:
            print("Python reported the following error: " + str(e))
        return "Couldn't create a file"
